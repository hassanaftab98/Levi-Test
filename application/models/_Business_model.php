...
Class Business_model extends CI_Model
{
	...
	{
		$query = $this->db->select('sub.*,sub_pack.sub_package,sub_pack.sub_package_price')
		->from('subscriptions as sub')
	...
	{
		$this->db->where("invoice_id", $invoice_id)->delete("business_invoice");
		return true;
	}
	...
	{
		$pay = array(
			'payment_method_id' => $data['amount'],
			'paid_amount' => $data['payment_method'],
			'added_by' => $this->session->userdata['id']
