									...
									<div class="nk-block-head nk-block-head-sm">
										<div class="nk-block-between">
											<div class="nk-block-head-content">
												<h3 class="nk-block-title page-title">Tax Types</h3>
											...
											<table class="datatable-init table">
												...
												<?php for ($i = 0; $i < count($tax_type); $i++) : ?>
													...
													<tr>
														...
														<td><?= $tax_type[$i]['tax_status'] ?> </td>

														<td>
															<button type="button" onclick="validate(this)" value="<?= $tax_type[$i]['tax_status_id']; ?>" class="btn btn-xs btn-danger"><span class="icon ni ni-trash"></span></button>
