...
<body class="nk-body bg-lighter npc-general has-sidebar ">
														...
														<div class="col-sm-4">
															<div class="form-group">
																<div class="form-control-wrap">
																	...
																	<input type="text" class="form-control business-name" name="business_name" id="business_name" placeholder="Business Name">
																</div>
															</div>
														</div>
														<div class="col-sm-4">
															<div class="form-group">
																<div class="form-control-wrap">
																	...
																	<input type="text" class="form-control email-co" name="business_email" id="email" placeholder="Email: admin@example.com">
																</div>
															</div>
														</div>
														<div class="col-sm-4">
														...
														<div class="col-sm-3">
															<div class="form-group">
																<div class="form-control-wrap">
																	...
																	<input type="text" class="form-control user-name" name="name" placeholder="User Name" readonly>
																</div>
															</div>
														</div>
														<div class="col-sm-3">
	...
	<script>
		...
		$('.business-name').change(function(e) {
			// console.log(e.target.value)
			$('.user-name').val(e.target.value);
