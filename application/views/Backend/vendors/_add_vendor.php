									...
									<div class="card card-preview">
										<div class="card-inner">
											<ul class="nav nav-tabs mt-n3" id="myTab">
												...
												<li class="nav-item">
													<a class="nav-link" data-toggle="tab" href="#tabItem6"><em class="icon ni ni-contact"></em><span>Contact Info</span></a>
												</li>
												<li class="nav-item">
													<a class="nav-link" data-toggle="tab" href="#tabItem7"><em class="icon ni ni-map-pin"></em><span>Ship To Address</span></a>
												</li>
											</ul>
												...
												<div class="tab-pane active animated fadeIn" id="tabItem5">
													<!--<form action="#" method="POST" id="add_vendor">-->
														<div class="row g-4">
															...
															<div class="col-12">
																<div class="form-group">
																	<a class="btn btn-primary" data-toggle="tab" href="#tabItem6"><span>Next</span></a>
												...
												<div class="tab-pane animated fadeIn" id="tabItem6">
													...
													<!--<form action="#" method="POST" id="add_vendor_contact">-->
														<div class="row g-4">
															...
															<div class="col-12">
																<div class="form-group">
																	<a class="btn btn-primary" data-toggle="tab" href="#tabItem7"><span>Next</span></a>
																	<!--<button type="submit" class="btn btn-primary">Next</button>-->
																</div>
															</div>
														</div>
