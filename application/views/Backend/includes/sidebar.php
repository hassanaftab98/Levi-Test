	...
	<div class="nk-sidebar-element">
		<div class="nk-sidebar-content">
			<div class="nk-sidebar-menu" data-simplebar>
				<ul>
					<li>
						<div class="form-group" style="width: 90%; margin-left: 20px; padding-bottom: 4px;">
							<div class="form-control-wrap">
								<div class="form-icon form-icon-left">
									<em class="icon ni ni-search"></em>
								</div>
								<input type="text" class="form-control filtertxt" placeholder="Search">
							</div>
						</div>
					</li>
				</ul>
				<ul class="nk-menu" id="social-sidebar-menu">
					...
					<li class="nk-menu-item has-sub">
						...
						<ul class="nk-menu-sub">
							<li class="nk-menu-item">
								<a href="<?= base_url('Settings/company_info')?>" class="nk-menu-link"><span class="nk-menu-text">
									<i class="icon ni ni-bullet-fill"></i> Company information</span></a>
							</li>

							<li class="nk-menu-item">
								<a href="<?= base_url('backup/databases')?>" class="nk-menu-link"><span class="nk-menu-text">
									<i class="icon ni ni-bullet-fill"></i> Backup Database</span></a>
							</li>
							<li class="nk-menu-item">
								<a href="<?= base_url('Settings/smtp_configuration')?>" class="nk-menu-link">
								<span class="nk-menu-text"><i class="icon ni ni-bullet-fill"></i> Email configuration</span></a>
							</li>
							<li class="nk-menu-item">
								<a href="<?= base_url('Settings/login_settings')?>" class="nk-menu-link">
								<span class="nk-menu-text"><i class="icon ni ni-bullet-fill"></i> Login Settings</span></a>
							</li>
						</ul><!-- .nk-menu-sub -->
					</li><!-- .nk-menu-item -->
